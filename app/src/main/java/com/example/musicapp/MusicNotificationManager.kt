...
class MusicNotificationManager internal constructor(private val mMusicService: MusicService){
    ...
    fun createNotification() : Notification{
        ...
        val contentIntent = PendingIntent.getActivity(mMusicService,REQUEST_CODE,openPlayerIntent,0)
    ...
    private fun notificationAction(action: String):NotificationCompat.Action{
        ...
        when(action){
            PREV_ACTION-> icon = R.drawable.ic_baseline_skip_previous_24
            PLAY_PAUSE_ACTION->
            ...
            NEXT_ACTION-> icon = R.drawable.ic_baseline_skip_next_24
            else -> icon = R.drawable.ic_baseline_skip_previous_24
        }
